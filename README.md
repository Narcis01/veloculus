...
```
cd existing_repo
git remote add origin https://appme.miele.com/dvcs/sh.dap/tools/veloculus.git
git branch -M master
...
- [ ] [Set up project integrations](https://appme.miele.com/dvcs/sh.dap/tools/veloculus/-/settings/integrations)
...
## Decision upon JavaFx vs Swing

| Swing                                                 | JavaFx                                                         |
|-------------------------------------------------------|----------------------------------------------------------------|
| Swing has more number<br/> of components to it        | Less component as compare<br/> to legacy Swing APIs            |
| Standard UI components can be<br/>designed with Swing | GUI components can be created with<br/>advanced look and feel  |
| Swing APIs are being used to write UI<br/> components | JavaFx scripts and fast UI development with screen<br/>builder |
| No new functionality introduction for future          | JavaFx has rich new toolkit,expected to grow in future         |
| Legacy UI library fully featured                      | Up and coming feature rich UI<br/>components                   |
| MVC support across components lac consistency         | Friendly with MVC pattern                                      |
