...
public class ExportController {
    ...
    @FXML
    public Button devsButton;
    @FXML
    public Button sprintsButton;

    /**
     * Method to export teams
     */
    public void exportTeams(ActionEvent actionEvent) throws IOException {
            migrationDataImp.exportTeam();
            teamsButton.setDisable(true);
    }
    /**
     * Method to export developers
     */
    public void exportDevs(ActionEvent actionEvent) throws IOException {
            Team team = teamServiceImp.findByName(comboDev.getValue().toString());
            migrationDataImp.exportDev(team);
            devsButton.setDisable(true);
    }
    /**
     * Method to export sprints
     */
    public void exportSprints(ActionEvent actionEvent) throws IOException {
            migrationDataImp.exportSprints((String) comboTeam.getValue());
            sprintsButton.setDisable(true);
    }
    /**
