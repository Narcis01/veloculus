...
public class ImportController {
    ...
    /**
     * Method to import developers
     */
    public void importDevs(ActionEvent actionEvent) throws IOException {
        Team team = teamServiceImp.findByName(teams.getValue().toString());
        migrationDataImp.importDev(team);
    }

    /**
     * Method to import teams
     */
    public void importTeams(ActionEvent actionEvent) throws IOException {
        migrationDataImp.importTeam();
    }

    /**
     * Method to import sprints
     */
    public void importSprints(ActionEvent actionEvent) throws IOException {
        Team team = teamServiceImp.findByName(sprints.getValue().toString());
        migrationDataImp.importSprint(team);
    }
